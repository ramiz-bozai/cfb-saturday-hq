...
select
    ...
    ps.pass_att as prior_pass_att,
    ps.pass_yds as prior_pass_yds,
    ps.rush_yds as prior_rush_yds,
    ps.rush_att as prior_rush_att,
    ps.rec_yds as prior_rec_yds,
    ps.tackles as prior_tackles,
    ps.tfl as prior_tfl,
    ps.sacks as prior_sacks,
    ps.interceptions as prior_interceptions,
    ps.kick_points as prior_kick_points,
    ps.pass_int as prior_pass_int,
    ps.fumbles_lost as prior_fumbles_lost,
    ps.stars,
